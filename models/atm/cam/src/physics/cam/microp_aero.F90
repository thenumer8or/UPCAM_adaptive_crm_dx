...
subroutine microp_aero_run ( &
   ...
   do k = 1, pver
      do i = 1, ncol
       ...
       !wsubi(i,k) = 0.010_r8  !haprish capped this to test suppressing the excessive CDNC activation in UP.
       !wsub(i,k) = 0.00020_r8    !haprish capped this to test suppressing the excessive CDNC activation in UP.
       !if(i*k .eq. 1) then
       ! write(6, *) 'hparish checking if wsub mod has taken effect, wsub(1,1) = ', wsub(i,k)
       !endif
   ...
   if (clim_modal_aero) then
      ...
      !write(6, *) 'hparish checking top_lev, pver = ', top_lev, pver
