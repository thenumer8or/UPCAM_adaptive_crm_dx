...
! following Chris B.'s suggestion to reduce the mean TOA LW bias in UP,
! hparish is increasing the ice termial velocity to this:
!         vt_ice = min(0.95,8.66*(max(0.,qic)+1.e-10)**0.24)
